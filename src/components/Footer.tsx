      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <img src={vibeLogo} alt="Vibelets" className="h-8 w-auto mb-4" />
            <p className="text-sm text-muted-foreground leading-relaxed">
              AI-powered ad campaign automation for non-marketers. Launch, monitor, and optimize your ads with ease.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#platforms" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Platforms</a></li>
